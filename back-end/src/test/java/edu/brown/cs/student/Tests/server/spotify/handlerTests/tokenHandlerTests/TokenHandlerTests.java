...
public class TokenHandlerTests {
  ...
  /**
   * Method that tests that the token is cached and the same one is returned to the user.
   *
   * @throws Exception any exception that could occur from making the api call.
   */
  @Test
  public void testCaching() throws Exception {
    ...
    JsonAdapter<Map> jsonAdapter = moshi.adapter(Map.class);
    Map<String, String> responseBody = jsonAdapter.fromJson(response.body());
    String token1 = responseBody.get("token");

    Map<String, String> queryParams2 = new HashMap<>();
    HttpResponse<String> response2 = tryRequest("token", queryParams2);
    Moshi moshi2 = new Moshi.Builder().build();
    JsonAdapter<Map> jsonAdapter2 = moshi2.adapter(Map.class);
    Map<String, String> responseBody2 = jsonAdapter2.fromJson(response2.body());
