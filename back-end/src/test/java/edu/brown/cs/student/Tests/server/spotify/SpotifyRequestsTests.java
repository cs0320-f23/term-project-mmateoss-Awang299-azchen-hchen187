...
public class SpotifyRequestsTests {
  ...
  @Test
  public void testGetSong() throws URISyntaxException, IOException, InterruptedException {
  ...
  @Test
  public void testGetFeatures() throws URISyntaxException, IOException, InterruptedException {
    // all the song names
  ...
  @Test
  public void testGetRecommendation() throws URISyntaxException, IOException, InterruptedException {

    String seedTrack = "1fXiYSWmkKJfRKMegCkI11";
    Recommendation rec =
        this.data.getRecommendation(
            this.token, "3", seedTrack, "0.2", "1", "0.4", "1", "0.6", "1", "0", "1", "0.5", "1");
  ...
  public void testGetSongPrompt() throws Exception {
    ...
    Assert.assertEquals(song.tracks().items().get(0).id(), "6gU9OKjOE7ghfEd55oRO57");
    Assert.assertEquals(song.tracks().items().get(0).name(), "The Weekend");
  }
}
