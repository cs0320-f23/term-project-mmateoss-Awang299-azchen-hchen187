 ...
 * @param explicit Whether the track has explicit lyrics ( true = yes it does; false = no it does
 *     not OR unknown).
 ...
 * @param track_number The number of the track. If an album has several discs, the track number is
 *     the number on the specified disc.
 * @param preview_url A link to a 30-second preview (MP3 format) of the track. Can be null
 * @param name The name of the track.
 */
public record TrackProps(
    int duration_ms,
    boolean explicit,
    String href,
    String id,
