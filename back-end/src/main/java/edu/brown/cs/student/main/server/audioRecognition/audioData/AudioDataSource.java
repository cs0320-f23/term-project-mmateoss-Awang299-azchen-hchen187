...
public class AudioDataSource {
   ...
   * @param encodedAudio Base64 encoded version of the audio, allowing us to send it securly through
   *     an API call.
  ...
  /**
   * Helper method that makes a request from API to get needed information and turns it into an
   * AudioObj object.
   *
   * @param uriString String that is the URI where we get the information from.
   * @return AudioObj object which is the contents of the Json returned from the API called.
   * @throws URISyntaxException exception where URI syntax is incorrect.
   * @throws IOException exception where it failed to read/open information.
   * @throws InterruptedException exception where connection to API is interrupted.
   *     <p>https://github.com/deepgram-starters/deepgram-java-starters/blob/main/Starter-01/src/main/java/com/deepgram/App.java
   */
