...
public class LyricsHandler implements Route {
  ...
  public Object handle(Request request, Response response) {
    ...
    try {
      ...
      System.out.println("fromLanguage: " + data.getLanguageCode(fromLanguage).code());
      System.out.println("before toLanguage: " + toLanguage);
      System.out.println("after toLanguage: " + data.getLanguageCode(toLanguage).code());
      ...
      for (String[] line : defaultLyrics) {
        ...
        line[2] =
            this.translateData
                .getTranslation(
                    line[1].replaceAll("\"", "").replace("\'", ""), fromLanguage, toLanguage)
                .translatedText();
      }
