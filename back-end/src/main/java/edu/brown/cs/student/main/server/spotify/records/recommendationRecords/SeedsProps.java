 ...
 *
 * @param afterFilteringSize The number of tracks available after min_* and max_* filters
 *                          have been applied.
 * @param afterRelinkingSize The number of tracks available after relinking for
 *                          regional availability.
 * @param href A link to the full track or artist data for this seed. For tracks this will be
 *            a link to a Track Object.
 * @param id The id used to select this seed. This will be the same as the string used in
 *           the seed_artists, seed_tracks or seed_genres parameter.
