...
/**
 * TokenHandler class, used to allow the frontend to get access to a spotify access token which they
 * can then use to get a playback sdk or to make other calls to the backend.
 */
