...
): Promise<RecommendationOutputData> {
  let openParen = /\(/gi;
  let closeParen = /\)/gi;
  let andSymbol = /&/gi;
  let title = selectedTrackTitle
    .replace(openParen, "%28")
    .replace(closeParen, "%29")
    .replace(andSymbol, "%26");
